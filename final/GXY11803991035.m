classdef GXY11803991035 < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        Menu_35      matlab.ui.container.Menu
        Menu_36      matlab.ui.container.Menu
        Menu_37      matlab.ui.container.Menu
        Menu_38      matlab.ui.container.Menu
        Menu_39      matlab.ui.container.Menu
        Menu_21      matlab.ui.container.Menu
        Menu_31      matlab.ui.container.Menu
        Menu_40      matlab.ui.container.Menu
        Menu_43      matlab.ui.container.Menu
        Menu_44      matlab.ui.container.Menu
        Menu_45      matlab.ui.container.Menu
        ...
        Menu_42      matlab.ui.container.Menu
        ...
        Menu_41      matlab.ui.container.Menu
        ...
        Menu_46      matlab.ui.container.Menu
    ...
    methods (Access = private)
        ...
        function g = Butterworth(~,f,D_0)
            if( ~( size(f,3)-3))%判断是否为彩色图
                f=rgb2gray(f);
            end
            f = mat2gray(f,[0 255]);
            [M,N] = size(f);
...
%             imwrite(f,fullFilePath);
        ...
        % Menu selected function: Menu_36
        function Menu_36Selected(app, event)
            filterspec = {'*.jpg;*.tif;*.png;*.gif','All Image Files'};
            [f, p] = uigetfile(filterspec);
            fname = [p f];
            imageCalcu = imread(fname);
            [a, b, ~] = size(app.Image);
            imageCalcu = imresize(imageCalcu,[a, b]);
            pImage = app.Image;
            
            pImage = imadd(imageCalcu,pImage);
        ...
        % Menu selected function: Menu_37
        function Menu_37Selected(app, event)
            filterspec = {'*.jpg;*.tif;*.png;*.gif','All Image Files'};
            [f, p] = uigetfile(filterspec);
            fname = [p f];
            imageCalcu = imread(fname);
            ...
            pImage = imsubtract(imageCalcu,pImage);
        ...
        % Menu selected function: Menu_38
        function Menu_38Selected(app, event)
            filterspec = {'*.jpg;*.tif;*.png;*.gif','All Image Files'};
            [f, p] = uigetfile(filterspec);
            fname = [p f];
            imageCalcu = imread(fname);
            ...
            pImage = immultiply(imageCalcu,pImage);
        ...
        % Menu selected function: Menu_39
        function Menu_39Selected(app, event)
            filterspec = {'*.jpg;*.tif;*.png;*.gif','All Image Files'};
            [f, p] = uigetfile(filterspec);
            fname = [p f];
            imageCalcu = imread(fname);
            ...
            pImage = imdivide(imageCalcu,pImage);
        ...
        % Menu selected function: Menu_41
        function Menu_41Selected(app, event)
            an = inputdlg('截止频率：');
            an = str2double(an);
            pImage = app.Image;
            pImage = Butterworth(app,pImage,an);
            app.Image = pImage;
            imshow(app.Image,'Parent',app.ImageAxes);
            showHist(app);
        end

        % Menu selected function: Menu_42
        function Menu_42Selected(app, event)
            I = app.Image;
        ...
        % Menu selected function: Menu_43
        function Menu_43Selected(app, event)
            pImage = app.Image;
            C = 1;
            Gamma = 0.4;
            f = mat2gray(pImage,[0 255]);
            g2 = C*(f.^Gamma);
        ...
        % Menu selected function: Menu_44
        function Menu_44Selected(app, event)
            pImage = app.Image;
            f = mat2gray(double(pImage));
            S = log(1+10*f)/(log(11));
        ...
        % Menu selected function: Menu_45
        function Menu_45Selected(app, event)
            pImage = app.Image;
            f = mat2gray(pImage,[0 255]);
            [M,N] = size(f);
            g = zeros(M,N);
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIFigure.Position = [100 100 1080 720];
            ...
            app.RGB2gray.Text = '灰度转换';

            % Create Menu_35
            app.Menu_35 = uimenu(app.transform);
            app.Menu_35.Text = '图像合成';

            % Create Menu_36
            app.Menu_36 = uimenu(app.Menu_35);
            app.Menu_36.MenuSelectedFcn = createCallbackFcn(app, @Menu_36Selected, true);
            app.Menu_36.Text = '图像加法';

            % Create Menu_37
            app.Menu_37 = uimenu(app.Menu_35);
            app.Menu_37.MenuSelectedFcn = createCallbackFcn(app, @Menu_37Selected, true);
            app.Menu_37.Text = '图像减法';

            % Create Menu_38
            app.Menu_38 = uimenu(app.Menu_35);
            app.Menu_38.MenuSelectedFcn = createCallbackFcn(app, @Menu_38Selected, true);
            app.Menu_38.Text = '图像乘法';

            % Create Menu_39
            app.Menu_39 = uimenu(app.Menu_35);
            app.Menu_39.MenuSelectedFcn = createCallbackFcn(app, @Menu_39Selected, true);
            app.Menu_39.Text = '图像除法';
            ...
            % Create Menu_40
            app.Menu_40 = uimenu(app.Menu_21);
            app.Menu_40.Text = '灰度映射';

            % Create Menu_43
            app.Menu_43 = uimenu(app.Menu_40);
            app.Menu_43.MenuSelectedFcn = createCallbackFcn(app, @Menu_43Selected, true);
            app.Menu_43.Text = '对数变换';

            % Create Menu_44
            app.Menu_44 = uimenu(app.Menu_40);
            app.Menu_44.MenuSelectedFcn = createCallbackFcn(app, @Menu_44Selected, true);
            app.Menu_44.Text = '伽马变换';

            % Create Menu_45
            app.Menu_45 = uimenu(app.Menu_40);
            app.Menu_45.MenuSelectedFcn = createCallbackFcn(app, @Menu_45Selected, true);
            app.Menu_45.Text = '灰度拉伸';
            ...
            % Create Menu_42
            app.Menu_42 = uimenu(app.Menu_23);
            app.Menu_42.MenuSelectedFcn = createCallbackFcn(app, @Menu_42Selected, true);
            app.Menu_42.Text = '类间最大方差';
            ...
            % Create Menu_41
            app.Menu_41 = uimenu(app.Menu_25);
            app.Menu_41.MenuSelectedFcn = createCallbackFcn(app, @Menu_41Selected, true);
            app.Menu_41.Text = '巴特沃斯';
            ...
            % Create Menu_46
            app.Menu_46 = uimenu(app.Menu_28);
            app.Menu_46.Text = '霍夫曼译码';

            % Create UITable
            app.UITable = uitable(app.UIFigure);
            app.UITable.ColumnName = {'熵'};
            app.UITable.RowName = {};
            app.UITable.Position = [921 310 160 58];

            % Create TextArea
            app.TextArea = uitextarea(app.UIFigure);
            app.TextArea.Position = [926 221 150 60];
            ...
            app.ImageAxes.Position = [1 1 921 720];
            ...
            app.GreenAxes.Position = [921 483 160 117];
            ...
            app.BlueAxes.Position = [921 367 160 117];
            ...
            app.RedAxes.Position = [921 599 160 117];
