...
% fields:
%   Y.min  Minmum value of X plus 32768
%   Y.size Size of X
...
% 'link'contains the address (+) to node pairs for node symbol strings plus
% '0' and '1' or address (-) to decoded Huffman codewords in 'map'. Array
% 'left' is a list of nodes yet to be processed for 'link' entries.
